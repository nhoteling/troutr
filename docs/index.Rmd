...
<b>There is still work to do.</b>  For example, now we need to use the probabilities to actually make a decision.  Also, we should compare the results with the "known" locations.  More to come soon...
